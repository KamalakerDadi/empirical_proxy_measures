...
DT_cond_proxy <- fread('mod23_cond_proxy.csv')
DT_cond_proxy_bs <- fread('mod23_cond_proxy_bs.csv')
DT_cond_target <- fread('mod23_cond_target.csv')
DT_cond_target_bs <- fread('mod23_cond_target_bs.csv')
