...
DT_cond_proxy <- fread('mod_cond_proxy.csv')
DT_cond_proxy_bs <- fread('mod_cond_proxy_bs.csv')

DT_cond_target <- fread('mod_cond_target.csv')
DT_cond_target_bs <- fread('mod_cond_target_bs.csv')

DT_margin_proxy <- fread('mod_margin_proxy.csv')
DT_margin_proxy_bs <- fread('mod_margin_proxy_bs.csv')

DT_margin_target <- fread('mod_margin_target.csv')
DT_margin_target_bs <- fread('mod_margin_target_bs.csv')
...
#' Plot point estimates + standard outputs for marginal proxy model
