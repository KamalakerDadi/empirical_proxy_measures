...
train_sizes = [100, 500, 1000, 1500, 2000, 2500, 3000, 3600]
# Model
...
train_scores.to_csv('inputs/train_scores_predict_age_at_assessment.csv')

validation_scores = pd.DataFrame(validation_scores)
validation_scores.to_csv('inputs/validation_scores_predict_age_at_assessment.csv')
