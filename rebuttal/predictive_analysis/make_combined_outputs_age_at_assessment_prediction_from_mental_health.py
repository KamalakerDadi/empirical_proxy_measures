...
X_iterate = zip([brain_dmri_fa, brain_dmri_icvf, brain_dmri_isovf, brain_dmri_l1,
                 ...
                 brain_dmri_od, brain_smri_plus, mental_health, fluid_intelligence],
                 ['fa', 'icvf', 'isovf', 'l1', 'l2', 'l3', 'md', 'mo', 'od',
                  'smri', 'Mental health', 'Fluid \n intelligence'])
...
# save outputs
savedir = join('outputs', 'combined_age_at_assessment_prediction_from_mental_health')
