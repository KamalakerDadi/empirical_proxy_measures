#'---
#'title: "Plot prediction outputs on test set (validation)"
#'author: "Denis A. Engemann, Kamalaker Dadi"
#'Run prepare_csvs_for_figure_2.r to get brain_inference.csv and
#'gen_observed_r2s.csv
...
{
  if(imaging == T){
    fname <- "imaging_non_imaging.csv"
  }else{
    fname <- "non_imaging.csv"
  }
