...
from ukbb_variables import (brain_smri_plus,
...
X_iterate = zip([brain_smri_plus, fluid_intelligence, neuroticism],
...
# save outputs
savedir = join('outputs', 'imaging_neuroticism_prediction_from_brain_volumes')
