...
from ukbb_variables_multi_output_prediction import (brain_dmri_fa, brain_dmri_icvf,
...
# save outputs
savedir = join('outputs', 'imaging_neuroticism_prediction_from_brain_volumes_white_matter')
