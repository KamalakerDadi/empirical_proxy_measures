...
df = df.drop(columns=['eid', '20016-2.0', '21022-0.0'], axis=1)
df_test = df_test.drop(columns=['eid', '20016-2.0', '21022-0.0'], axis=1)
...
# save outputs
savedir = join('outputs', 'classification_combined_age_prediction')
